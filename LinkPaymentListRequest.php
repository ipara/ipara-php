...
class LinkPaymentCreateRequest extends  BaseRequest
{
    ...
    public function execute(Settings $settings)
    {
          ...
          return  restHttpCaller::post($settings->BaseUrl . "/corporate/merchant/linkpayment/create", Helper::GetHttpHeaders($settings, "application/json", 'token'), $this->toJsonString());
    }
