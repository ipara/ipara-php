...
*/   
    ...
    {      
        ...
        {
            $this->PublicKey = "WY48CP014UFLQ4A"; // todo test keys "Public Magaza Anahtarı - size mağaza başvurunuz sonucunda gönderilen publik key (açık anahtar) bilgisini kullanınız.",
            $this->PrivateKey = "WY48CP014UFLQ4A0VSW12US00"; // todo test keys "Private Magaza Anahtarı  - size mağaza başvurunuz sonucunda gönderilen privaye key (gizli anahtar) bilgisini kullanınız.",
