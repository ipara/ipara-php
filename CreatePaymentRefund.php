	...
	<fieldset>
       ...
       <!-- Text input-->    
        <div class="form-group">
			...
			<div class="col-md-4">
				<input name="refundHash" type="text" value="002gn9kbjGN+9Y1XegSJ5vcy/i0PxfVfRCm5Rqn3TG/36oXO50jfesrEBQPikjubr6v"
					class="form-control input-md" required="">
...
$request->refundHash  =$_POST["refundHash"];
$request->clientIp=Helper::get_client_ip();
$response=CreatePaymentRefundRequest::execute($request,$settings); 
